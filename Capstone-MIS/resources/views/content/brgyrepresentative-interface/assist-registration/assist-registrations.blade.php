...
@section('title', 'Assist Beneficiary Registration')
...
<div class="container py-4">
    <div class="card shadow rounded-4">
        <div class="card-body p-4">
            <h2 class="text-center mb-4 fw-bold">Assist Beneficiary Registration</h2>

            <div class="alert alert-info mb-4">
                You are registering on behalf of a beneficiary. Your name will be recorded as the assisting Barangay Representative.
            </div>
            ...
            <!-- Form -->
            <form method="POST" action="{{ route('assist-registration.store') }}" id="assistRegistrationForm">
                @csrf
                ...
                <div id="step1" class="step">
                    ...
                    <div class="mt-4 d-flex justify-content-between">
                        <a href="{{ route('brgyrep.dashboard') }}" class="btn btn-secondary">Back to Dashboard</a>
                ...
                <div id="step4" class="step d-none">
                    ...
                    <div class="mt-4 d-flex justify-content-between">
                        ...
                        <button type="button" onclick="validateStep4()" class="btn btn-success">✔ Register Beneficiary</button>
                    </div>
                </div>
            </form>
        </div>
...
<script src="{{ asset('js/assist-registration.js') }}"></script>
<script>
