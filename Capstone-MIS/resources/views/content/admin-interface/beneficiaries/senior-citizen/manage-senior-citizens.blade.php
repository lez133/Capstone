...
<div class="container py-4">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4">
            <a href="{{ route('senior-citizens.verified', $encryptedBarangayId) }}" class="text-decoration-none">
        ...
        <div class="col-md-6 mb-4">
            <a href="{{ route('senior-citizens.not-verified', $encryptedBarangayId) }}" class="text-decoration-none">
                <div class="card shadow-sm h-100 hover-card position-relative">
                    ...
                    <span class="position-absolute badge rounded-pill
                        {{ $notVerifiedCount > 0 ? 'bg-danger' : 'bg-secondary' }}"
